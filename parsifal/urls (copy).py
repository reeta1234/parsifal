...
urlpatterns = ['parsifal',
    ...
    url('auth/', include('parsifal.authentication.urls'),namespace='authentication'),
    ...
    url('review/', include('parsifal.reviews.urls'),namespace='review'),
    ...
    url('review/planing/', include('parsifal.reviews.planning.urls'),namespace='review'),
