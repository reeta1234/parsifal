...
def reset(request):
    return PasswordResetView(template_name='auth/reset.html',
        email_template_name='auth/reset_email.html',
        subject_template_name='auth/reset_subject.txt',
        post_reset_redirect=r('authentication:success'))

def reset_confirm(request, uidb64=None, token=None):
    return PasswordResetConfirmView(template_name='auth/reset_confirm.html',
        uidb64=uidb64, token=token, post_reset_redirect=r('authentication:signin'))
