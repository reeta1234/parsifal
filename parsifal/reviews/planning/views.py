...
def save_question(request):
    ...
    try:
        ...
        return render(request,'planning/partial_planning_question.html', context)
    except:
        return HttpResponseBadRequest()
...
def add_or_edit_question(request):
    ...
    try:
        ...
        try:
            ...
            question = Question(review=review)
        context = RequestContext(request, {'question':question})
        return render(request,'planning/partial_planning_question_form.html', context)
    except:
        return HttpResponseBadRequest()
...
def add_quality_assessment_question(request):
    try:
        ...
        return render(request,'planning/partial_quality_assessment_question_form.html', context)
    except:
        return HttpResponseBadRequest()
...
def save_quality_assessment_question(request):
    try:
        ...
        context = RequestContext(request, {'quality_question': quality_question})
        return render(request,'planning/partial_quality_assessment_question.html', context)
    except:
        return HttpResponseBadRequest()
...
def add_quality_assessment_answer(request):
    try:
        ...
        return render(request,'planning/partial_quality_assessment_answer_form.html', context)
    except:
        return HttpResponseBadRequest()
...
def save_quality_assessment_answer(request):
    try:
        ...
        context = RequestContext(request, {'quality_answer': quality_answer})
        return render(request,'planning/partial_quality_assessment_answer.html', context)
    except:
        return HttpResponseBadRequest()
...
def add_new_data_extraction_field(request):
    ...
    return render(request,'planning/partial_data_extraction_field_form.html', context)
...
def save_data_extraction_field(request):
    try:
        ...
        context = RequestContext(request, {'field': field})
        return render(request,'planning/partial_data_extraction_field.html', context)
    except:
        return HttpResponseBadRequest()
